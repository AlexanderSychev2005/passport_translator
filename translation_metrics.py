...
translations_deepl = [translator_deepl.translate_text(sentence, target_lang='UK').text for sentence in
                      english_sentences]
...
bleu_google = bleu.compute(predictions=translations_google, references=references)['bleu']
